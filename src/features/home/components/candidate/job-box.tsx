...
export const JobBox = ({ jobProps }: { jobProps: job }) => {
    ...
    return (
        <div
            ...
            className="flex w-[872px] h-[100px] p-8 pr-[41px] transition-all duration-500 ease-in-out items-center justify-between border rounded-[12px] hover:bg-gradient-to-r from-[#fff2da] to-[#FFF] hover:border-[1px] hover:scale-[1.01] hover:border-[blue]"
        >
