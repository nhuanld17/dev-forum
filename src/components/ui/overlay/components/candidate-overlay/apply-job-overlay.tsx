...
const CLOUDINARY_UPLOAD_URL = "https://api.cloudinary.com/v1_1/dhsv9jnul/raw/upload"; // raw/upload để hỗ trợ các loại tệp không phải hình ảnh
                ...
                <>
                    <div className="flex relative flex-col border-2 rounded-lg p-8 gap-5 bg-white w-full h-[300px]">
                        ...
                        <div className="flex flex-col gap-2">
                            <label htmlFor="file" className="text-[14px] font-[400]">Upload Resume (PDF only)</label>
                            <input
                                id="file"
                                type="file"
                                accept=".pdf"
                        ...
                        <input value={id} type="hidden" {...methods.register("idJob")} /> {/* Input ẩn */}
                        <input type="hidden" {...methods.register("cvLink")} /> {/* Input ẩn */}
                        <Button
                            type="submit"
